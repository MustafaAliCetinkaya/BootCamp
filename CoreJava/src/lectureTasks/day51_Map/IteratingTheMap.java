...
public class IteratingTheMap {
    ...
    public static void main(String[] args) {
        ...
        int countMoreThan90 = 0;
        int countLessThan90 = 0;
        ...
        System.out.println("earlyBirds = " + earlyBirds + ", Number of early birds: " + countMoreThan90);
        System.out.println("angryBirds = " + angryBirds + ", Number of angry birds: " + countLessThan90);
