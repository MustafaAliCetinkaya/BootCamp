...
public class BulkOperations {
    ...
    public static void main(String[] args) {
        ...
        list.removeAll( Arrays.asList(3,5,8) );//All selected numbers will be deleted.
        ...
        numbers.retainAll(Arrays.asList(100, 200, 300));//Other numbers bill be deleted
        ...
        jobTitles.retainAll( Arrays.asList("QA", "SDET") );//Only selected words will remain in the list
