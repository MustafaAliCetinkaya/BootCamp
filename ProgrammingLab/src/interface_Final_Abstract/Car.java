...
public interface Car {//Bu Class değil interface. Interfacen NESNE  OLUŞTURULAMAZ.

    int number=26;//Değerleri değiştirlemez. "final" yani sabit olarak oluşur. Önünde gizli "final" yazar. Biz yazmasak da gizli olarak orada.
    String name="Mustafa";

    void addition(); //Metot oluşturulabilir ama interface de oluşan TÜM METOTLAR OTOMATİK ABSTRACT olur.
